...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        acc=new Intent(this, Accounts.class);
        Button accountPage = findViewById(R.id.buttonAcount);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            if (!fingerprintManager.isHardwareDetected()) {
                // If a fingerprint sensor isn’t available, then inform the user that they’ll be unable to use the app’s fingerprint functionality//
            ...
            if (!keyguardManager.isKeyguardSecure()) {
                ...
                if (initCipher()) {
                    ...
                    // The FingerprintHandler class is responsible
...
//Create the generateKey method that we’ll use to gain access to the Android keystore and generate the encryption key//
    ...
    //Create a new method to initialize the cipher//
